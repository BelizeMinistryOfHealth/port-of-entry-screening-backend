...
const (
	...
	SinovacFirst  VaccineDose = "LNG_REFERENCE_DATA_CATEGORY_VACCINE_SINOVAC_1ST_DOSE"
	SinovacSecond VaccineDose = "LNG_REFERENCE_DATA_CATEGORY_VACCINE_SINOVAC_2ND_DOSE"
)
